...
const BlogCard = ({ blog, deletable, handleDelete}) => {
  ...
  return (
    <div className="flex relative">
      ...
      <Link
        to={`/blog/${id}`}
        className="transition border-2 border-primary hover:border-secondary hover:scale-105 border-opacity-30 max-w-sm mx-auto group hover:no-underline focus:no-underline bg-gray-50"
      >
        <img
          role="presentation"
